...
from app.api.v1 import health, chat, owl, hr_corner, public_chat, rag, recommendations, tools, knowledge, metrics
...
api_v1_router.include_router(public_chat.router)
